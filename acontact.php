...
-->
	...
	<div id="otherways">
		...
		<div id="ways">
			...
			<div class="m_icon">
				<i class="fa fa-mobile" aria-hidden="true"></i>  <b>+250 786 734 567</b>
			</div>
			<div class="wt_icon" style="font-size: 14pt;">
				<i class="fa fa-whatsapp"></i> <b>+250 768 688 897</b>
			</div>
			<div class="mail_icon">
				<i class="fa fa-envelope" aria-hidden="true"></i> <b>amoris@gmail.com</b>
			</div>
			<div class="fb_icon" style="font-size: 14pt;">
				<i class="fa fa-facebook-square" aria-hidden="true"></i> <b>www.facebook.com/amoris restaurant</b>
			</div>
			<div class="tw_icon" style="font-size: 16pt;">
				<i class="fa fa-twitter-square" aria-hidden="true"></i> <b>free deliveryc</b>
			</div>
		</div>
	</div>
