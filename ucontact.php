...
-->
	...
	<div id="otherways">
		...
		<div id="ways">
			...
			<div class="m_icon">
				<i class="fa fa-mobile" aria-hidden="true"></i>  <b>+250 788 789 236</b>
			</div>
			<div class="wt_icon" style="font-size: 14pt;">
				<i class="fa fa-whatsapp"></i> <b>+250 96578893</b>
			</div>
			<div class="mail_icon">
				<i class="fa fa-envelope" aria-hidden="true"></i> <b>umucyo@gmail.com</b>
			</div>
			<div class="fb_icon" style="font-size: 14pt;">
				<i class="fa fa-facebook-square" aria-hidden="true"></i> <b>www.facebook.com/umucyo restaurant</b>
			</div>
