...
<?php
include('db_connect.php');
$del="<a href='del.php?' style='color:red;text-decoration: none;'>"."Delete"."</a>";
...
while($row = $result->fetch_assoc()) {
  $up="<a href='update.php?id=".$row['client_id']."'' style='color:blue;text-decoration: none;;'>"."Update"."</a>";
  $del="<a href='del.php?id=".$row['client_id']."' style='color:red;text-decoration: none;'>"."Delete"."</a>";
echo "<tr><td>" . $row["client_id"]. "</td><td>" . $row["fullname"] . "</td><td>"
. $row["username"]. "</td><td>". $row["email"]. "</td><td>" . $row["phone"]. "</td><td>"
. $row["password"]. "</td><td>" . $row["gender"]. "</td><td>" . $row["create_at"]."</td><td>".$del."</td><td>".  $up . "</td></tr>"  ;
}
echo "</table>";
} else { echo "0 results"; }
$conn->close();
